...
```bash
npm install react-authform
```

or with Yarn:

```bash
yarn add react-authform
```
...
import { AuthForms } from 'react-authform';
...
```jsx
import { LoginForm } from 'react-authform';
...
```jsx
import { SignUpForm } from 'react-authform';
